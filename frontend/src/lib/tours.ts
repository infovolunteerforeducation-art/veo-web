...
export const tours: Tour[] = [
  {
    ...
    image: "/tour-images/meo-vac-school-volunteer.webp",
    gallery: [
  ...
  },
  {
    ...
    image: "/tour-images/ly-son-ocean-cleanup.webp",
    gallery: [],
  ...
  },
  {
    ...
    category: "Kỹ năng",
    categoryClass: "bg-solar-orange text-pure-white",
    image: "/tour-images/da-lat-life-skills-class.webp",
    gallery: [],
  ...
  },
  {
    ...
    category: "Môi trường",
    categoryClass: "bg-tertiary-container text-pure-white",
    image: "/tour-images/can-gio-mangrove-volunteer.webp",
    gallery: [],
