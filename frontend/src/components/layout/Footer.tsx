...
const programs = [
  { label: "Du lịch tình nguyện", href: "#" },
  { label: "Workcamp", href: "#" },
  { label: "CSR", href: "#" },
  { label: "Social Leader Program (SLP)", href: "https://www.slp.edu.vn/", external: true },
];
...
const socials = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/volunteer-for-education",
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 py-10 px-6 max-w-[1200px] mx-auto">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-pure-white/80 leading-relaxed">
            Volunteer For Education (VEO) - Mạng lưới kết nối các tình nguyện viên tại Việt Nam và trên toàn thế giới
          </p>
          <div className="flex gap-3">
            {socials.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-9 h-9 rounded-full bg-pure-white/10 flex items-center justify-center text-pure-white hover:bg-solar-orange transition-colors"
              >
                {s.svg}
              </a>
            ))}
      ...
      <div className="border-t border-pure-white/10 py-6 px-6">
        <div className="max-w-[1200px] mx-auto text-center">
          <p className="text-sm text-pure-white/60">
            © 2025 Volunteer For Education (VEO). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
